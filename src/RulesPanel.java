...
public class RulesPanel extends JPanel {
    ...
    public void paint(Graphics g) {
        ...
        g2d.drawString("12) Если король может быть атакован, то это шах", width / 10, 16 * height / 20);
        g2d.drawString("13) Нельзя совершать ходы, чтобы король оставался/становился под шахом", width / 10, 17 * height / 20);
        g2d.drawString("14) Если нельзя сделать ход, не подставившись под удар, и нет шаха, то это пат", width / 10, 18 * height / 20);
        g2d.drawString("15) Если нельзя сделать ход, не подставившись под удар, и есть шах, то это пат", width / 10, 19 * height / 20);
    }
}
